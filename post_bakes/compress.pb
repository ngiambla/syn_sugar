...
rapidly%%lst%% %%#%% %%#%% %%#%% level %%#%% abstraction %%cmp_ta%% traditional rtl%%per%%]$~ ~$[for 
...
focused %%#%% power benefits %%#%% %%cmp_ta%% performance%%per%% 
...
%%#%% %%#%% %%cmp_ta%% %%#%% call point%%per%%]$~ ~$[additionally%%lst%% %%#%% master interface 
...
register samples %%#%% asynchronous input signal ]^[ %%cmp_t%% waits 
...
~$[specifically%%lst%% %%cmp_if%% %%#%% start signal %%#%% issued %%#%% %%#%% master interface ]^[ multiple%%dsh%%bit%%dsh%%wide data%%lst%% %%#%% %%#%% %%#%% crossed %%#%% using %%#%% 
...
%%#%% %%cmp%% multi%%dsh%%clock designs %%#%% single%%dsh%%clock designs%%lst%% wall%%dsh%%clock time%%per%%]$~ ~$[ratios larger %%cmp_ta%% 1 indicate %%#%% “win” ]f[ 
...
correctness%%per%%]$~ ~$[we verified %%#%% multi%%dsh%%domain circuits functioned single%%dsh%%clock design%%lst%% ]^[ %%cmp_h%%%%lst%% %%#%% %%#%% 1 %%#%% %%#%% ratio ]f[ %%#%% 
...
larger %%cmp_ta%% %%#%% %%#%% inlined case%%lst%% increasing cdc overheads ]^[ 
...
%%#%% %%#%% single function (and %%cmp_h%% %%#%% single domain)%%per%%]$~ 
...
]f[ clock%%dsh%%domain assignment%%lst%% %%#%% %%cmp_ta%% altering %%#%% programs 
