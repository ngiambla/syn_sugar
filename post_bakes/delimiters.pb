...
development of new technologies%%lst%% they do so at a lower level than 
...
d 
For example%%lst%% if a country used 30% gasoline ]^[ 70% diesel%%lst%% then their fuel price would reﬂect a greater weight placed on cost for diesel%%per%% 
e 
...
population%%per%%]$~ ~$[Therefore%%lst%% socio%%dsh%%demographic variables may not provide a good indicator of adoption levels when comparing countries%%per%%]$~ ~$[If EVs emerge from a niche market%%lst%% then socio%%dsh%%demographic 
